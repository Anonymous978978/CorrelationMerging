...
if not already_save:
    ...
    torch.save({"confs": id_confs, "preds": id_preds, "logits": id_logits, "ys": id_ys},
               "saved data/ResNet_cifar100_id_probs_data")
    print("saved data/ResNet_cifar100_id_probs_data saved")
    ...
    for ood_dataset in ["svhn", "isun", "lsun_c", "lsun_r", "tinyimagenet_c", "tinyimagenet_r"]:
        ...
        torch.save({"confs": ood_confs, "preds": ood_preds, "logits": ood_logits, "ys": ood_ys}, \
                   "saved data/ResNet_cifar100_{}_probs_data".format(ood_dataset))
        print("saved data/ResNet_cifar100_{}_probs_data saved".format(ood_dataset))
...
id_probs = torch.load("saved data/ResNet_cifar100_id_probs_data")
...
for ood_dataset in ["svhn", "isun", "lsun_c", "lsun_r", "tinyimagenet_c", "tinyimagenet_r"]:
    ood_probs[ood_dataset] = torch.load("saved data/ResNet_cifar100_{}_probs_data".format(ood_dataset))
