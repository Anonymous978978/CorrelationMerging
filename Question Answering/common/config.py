...
def register_args(parser):
    ...
    parser.add_argument(
        "--output_dir",
        default="predictions/dev_bioasq",
        type=str,
    ...
    parser.add_argument(
        "--predict_file",
        default="outputs/dev_bioasq.json",
        type=str,
...
def load_config_and_tokenizer(args):
    if args.dataset in ['simple', 'synth', 'comp']:
        ...
        if args.dataset == 'simple':
            ...
            config = SynBertConfig()
    elif args.dataset in ['hpqa', 'squad', 'bioasq', 'newsqa', 'naturalqa', 'trivia', 'hotpot', 'searchqa', 'textbookqa']:
        config = AutoConfig.from_pretrained(
        args.config_name if args.config_name else args.model_name_or_path,
        cache_dir=args.cache_dir if args.cache_dir else None,
        )
